...
echo 'cloudctl case launch --case ibm-cp-security --namespace cp4s --inventory installProduct --action upgrade-all --args "--license accept --helm3 /usr/local/bin/helm3 --inputDir cp4s-15/" --tolerance 1'
echo
cloudctl case launch --case ibm-cp-security --namespace cp4s --inventory installProduct --action upgrade-all --args "--license accept --helm3 /usr/local/bin/helm3 --inputDir cp4s-15/" --tolerance 1
echo
